        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    EventId = table.Column<int>(type: "integer", nullable: false),
                    InvoiceEmailAttachPdf = table.Column<bool>(type: "boolean", nullable: false),
                    InvoiceEmailSubject = table.Column<string>(type: "text", nullable: false),
                    InvoiceEmailTemplate = table.Column<string>(type: "text", nullable: false),
                    InvoiceEmailReplyTo = table.Column<string>(type: "text", nullable: false),
                    InvoiceEmailBccAddr = table.Column<string>(type: "text", nullable: false),
                    ReceiptEmailAttachPdf = table.Column<bool>(type: "boolean", nullable: false),
                    ReceiptEmailSubject = table.Column<string>(type: "text", nullable: false),
                    ReceiptEmailTemplate = table.Column<string>(type: "text", nullable: false),
                    ReceiptEmailReplyTo = table.Column<string>(type: "text", nullable: false),
                    ReceiptEmailBccAddr = table.Column<string>(type: "text", nullable: false),
                    ReservationEmailAttachPdf = table.Column<bool>(type: "boolean", nullable: false),
                    ReservationEmailSubject = table.Column<string>(type: "text", nullable: false),
                    ReservationEmailTemplate = table.Column<string>(type: "text", nullable: false),
                    ReservationEmailReplyTo = table.Column<string>(type: "text", nullable: false),
                    ReservationEmailBccAddr = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainSiteUrl = table.Column<string>(type: "text", nullable: false),
                    Currency = table.Column<string>(type: "text", nullable: false),
                    Language = table.Column<string>(type: "text", nullable: false),
                    AdminNotes = table.Column<string>(type: "text", nullable: false),
                    AccountId = table.Column<string>(type: "text", nullable: false),
                    TrialExpiresAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    DataJsUpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    MonthlyPrice = table.Column<decimal>(type: "numeric", nullable: false),
                    EnableCharging = table.Column<bool>(type: "boolean", nullable: false),
                    PackageId = table.Column<int>(type: "integer", nullable: false),
                    DecimalSeparator = table.Column<char>(type: "character(1)", nullable: false),
                    NumberGroupSeparator = table.Column<char>(type: "character(1)", nullable: false),
                    VenueName = table.Column<string>(type: "text", nullable: false),
                    VenueInfo = table.Column<string>(type: "text", nullable: false),
                    LogoFileId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Events_EventFiles_LogoFileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShowPrograms_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
